...
' -----------------------------------------------
' Nur mit passendem Benutzer ausfuehren.
' Anpassungen fuer paedML 3.x:
...
Sub Logon()
	...
	If (userName = DoOnlyThisUser) Then
		...
		If debugMode Then
			...
			WriteToLogfile "INFORMATION", "Logon", "userHomeDirectory: " & userHomeDirectory
			WriteToLogfile "INFORMATION", "Logon", "userLocalPath: " & userLocalPath
			WriteToLogfile "INFORMATION", "Logon", "homeDriveShareName: " & homeDriveShareName
		End If
